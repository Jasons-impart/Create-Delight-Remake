...
为了提高fps，整合包加入了较多渲染优化模组，在遇到渲染显示问题的时候可以尝试依次禁用下述模组，但渲染性能可能会受到影响

- Accelerated Rendering

- Entity Culling : 尤其在机械动力实体看不见时
...
本包的魔改中龙钢锤为七级锤，悚怖钢/终结龙锭锤为八级锤。镶嵌下界之星可增加一级，镶嵌纯粹黑暗可增加两级。锤头速度打磨满后也可加一级锤子等级。具体内容请查看tetra的任务。
