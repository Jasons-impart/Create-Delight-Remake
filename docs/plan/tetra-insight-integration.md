...
- Alpha 2：<https://github.com/SSWTLZZ69/TetraInsight/releases/tag/v0.1.0-alpha.2>
...
- Tetra Insight CurseForge 项目等待审核期间，暂以 `packwiz-files/mods/tetra_insight-0.1.0-alpha.2.jar` 分发，并在 `mods/tetra-insight.pw.toml` 标记为客户端模组。
...
- Tetra Insight `0.1.0-alpha.2` 已通过本地 `test build`、开发客户端与真实 CDR 界面回归。
