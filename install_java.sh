...
#   https://github.com/Griefed/ServerPackCreator/blob/7.1.8/serverpackcreator-api/src/main/resources/de/griefed/resources/server_files/default_java_template.sh
#
