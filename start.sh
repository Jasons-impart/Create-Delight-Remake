...
#   https://github.com/Griefed/ServerPackCreator/blob/7.1.8/serverpackcreator-api/src/main/resources/de/griefed/resources/server_files/default_template.sh
#
...
echo "Start script generated by ServerPackCreator 7.1.8."
