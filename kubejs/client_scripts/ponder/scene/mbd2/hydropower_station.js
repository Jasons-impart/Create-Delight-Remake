    ...
    event.create([
        ...
        .scene(
            ...
            (builder, util) => {
                ...
                scene.world.replaceBlocks([8, 3, 4, 9, 3, 4], Block.id("createdelight:steel_fan").blockState.setValue(global.CDClientJavaClasses.$BlockStateProperties.HORIZONTAL_FACING, Direction.WEST), true)
                scene.world.replaceBlocks([6, 3, 4, 7, 3, 4], Block.id("createdelight:forge_steel_fan").blockState.setValue(global.CDClientJavaClasses.$BlockStateProperties.HORIZONTAL_FACING, Direction.WEST), true)
                scene.world.replaceBlocks([4, 3, 4, 5, 3, 4], Block.id("createdelight:dragon_steel_fan").blockState.setValue(global.CDClientJavaClasses.$BlockStateProperties.HORIZONTAL_FACING, Direction.WEST), true)
                PonderUtil.setKineticSpeed(scene, [3, 3, 4, 12, 3, 4], 32)
                scene.idle(40)
                scene.world.replaceBlocks([8, 3, 4, 9, 3, 4], Block.id("createdelight:wooden_fan").blockState.setValue(global.CDClientJavaClasses.$BlockStateProperties.HORIZONTAL_FACING, Direction.WEST), true)
                scene.world.replaceBlocks([6, 3, 4, 7, 3, 4], Block.id("createdelight:wooden_fan").blockState.setValue(global.CDClientJavaClasses.$BlockStateProperties.HORIZONTAL_FACING, Direction.WEST), true)
                scene.world.replaceBlocks([4, 3, 4, 5, 3, 4], Block.id("createdelight:wooden_fan").blockState.setValue(global.CDClientJavaClasses.$BlockStateProperties.HORIZONTAL_FACING, Direction.WEST), true)
                PonderUtil.setKineticSpeed(scene, [3, 3, 4, 12, 3, 4], 32)
                scene.idle(40)
