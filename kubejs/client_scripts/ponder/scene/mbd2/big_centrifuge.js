    ...
    event.create([
        ...
        .scene(
            ...
            (builder, util) => {
                ...
                scene.world.replaceBlocks([2, 3, 4], Block.id("createdelight:steel_export_bus").blockState.trySetValue(global.CDClientJavaClasses.$BlockStateProperties.FACING, Direction.WEST), true)
                scene.world.replaceBlocks([2, 6, 4], Block.id("createdelight:steel_export_bus").blockState.trySetValue(global.CDClientJavaClasses.$BlockStateProperties.FACING, Direction.WEST), true)
                scene.idle(40)
                scene.rotateCameraY(90)
                scene.text(40, "在这个多方块结构中, 任意的钢制机壳都可以被钢制输入/输出总线代替", [7, 3.5, 4.5])
                scene.world.replaceBlocks([6, 3, 4], Block.id("createdelight:steel_export_bus").blockState.trySetValue(global.CDClientJavaClasses.$BlockStateProperties.FACING, Direction.EAST), true)
                scene.world.replaceBlocks([6, 6, 4], Block.id("createdelight:steel_export_bus").blockState.trySetValue(global.CDClientJavaClasses.$BlockStateProperties.FACING, Direction.EAST), true)
                scene.idle(40)
                scene.rotateCameraY(90)
                scene.text(40, "在这个多方块结构中, 任意的钢制机壳都可以被钢制输入/输出总线代替", [4.5, 3.5, 7])
                scene.world.replaceBlocks([4, 3, 6], Block.id("createdelight:steel_export_bus").blockState.trySetValue(global.CDClientJavaClasses.$BlockStateProperties.FACING, Direction.SOUTH), true)
                scene.world.replaceBlocks([4, 6, 6], Block.id("createdelight:steel_export_bus").blockState.trySetValue(global.CDClientJavaClasses.$BlockStateProperties.FACING, Direction.SOUTH), true)
                scene.idle(40)
        ...
        .scene(
            ...
            (builder, util) => {
                ...
                scene.world.replaceBlocks([2, 2, 4], Block.id("createdelight:steel_export_bus").blockState.trySetValue(global.CDClientJavaClasses.$BlockStateProperties.FACING, Direction.WEST), true)
                scene.idle(20)
                scene.rotateCameraY(90)
                scene.idle(20)
                scene.world.replaceBlocks([6, 2, 4], Block.id("createdelight:steel_import_bus").blockState.trySetValue(global.CDClientJavaClasses.$BlockStateProperties.FACING, Direction.EAST), true)
                scene.idle(20)
                scene.rotateCameraY(-90)
                scene.idle(20)
