    ...
    event.create([
        ...
        .scene(
            ...
            (builder, util) => {
                ...
                scene.idle(40)
                scene.world.hideSection([2, 2, 3, 2, 7, 9], Direction.WEST)
                scene.world.hideSection([3, 3, 4, 3, 5, 4], Direction.WEST)
                scene.world.hideSection([3, 3, 8, 3, 5, 8], Direction.WEST)
                scene.world.hideSection([3, 2, 2, 9, 7, 2], Direction.NORTH)
                ...
                scene.idle(40)
                scene.world.showSection([2, 2, 3, 2, 8, 9], Direction.EAST)
                scene.world.showSection([3, 3, 4, 3, 6, 4], Direction.EAST)
                scene.world.showSection([3, 3, 8, 3, 6, 8], Direction.EAST)
                scene.world.showSection([3, 2, 2, 9, 8, 2], Direction.SOUTH)
                scene.world.showSection([4, 3, 3, 4, 6, 3], Direction.SOUTH)
                scene.world.showSection([8, 3, 3, 8, 6, 3], Direction.SOUTH)
                scene.world.showSection([10, 2, 3, 10, 8, 9], Direction.WEST)
                scene.world.showSection([9, 3, 4, 9, 6, 4], Direction.WEST)
                scene.world.showSection([9, 3, 8, 9, 6, 8], Direction.WEST)
                ...
                scene.world.showSection([9, 3, 9, 9, 6, 9], Direction.DOWN)
                scene.world.showSection([6, 6, 6], Direction.DOWN)
                scene.idle(40)
