    ...
    e.create([
        ...
        .scene(
            ...
            (builder, util) => {
                ...
                scene.world.replaceBlocks([2, 2, 3], Block.id("createdelight:forged_steel_export_bus").blockState.trySetValue(global.CDClientJavaClasses["$BlockStateProperties"].FACING, Direction.WEST), true)
                scene.world.replaceBlocks([2, 2, 4], Block.id("createdelight:forged_steel_export_bus").blockState.trySetValue(global.CDClientJavaClasses["$BlockStateProperties"].FACING, Direction.WEST), true)
                scene.world.replaceBlocks([2, 2, 5], Block.id("createdelight:forged_steel_export_bus").blockState.trySetValue(global.CDClientJavaClasses["$BlockStateProperties"].FACING, Direction.WEST), true)
                scene.idle(40)
                scene.rotateCameraY(90)
                scene.text(40, "在这个多方块结构中, 任意的锻造钢机壳都可以被锻造钢输入/输出总线代替", [7, 2.5, 4.5])
                scene.world.replaceBlocks([6, 2, 3], Block.id("createdelight:forged_steel_import_bus").blockState.trySetValue(global.CDClientJavaClasses["$BlockStateProperties"].FACING, Direction.EAST), true)
                scene.world.replaceBlocks([6, 2, 4], Block.id("createdelight:forged_steel_import_bus").blockState.trySetValue(global.CDClientJavaClasses["$BlockStateProperties"].FACING, Direction.EAST), true)
                scene.world.replaceBlocks([6, 2, 5], Block.id("createdelight:forged_steel_import_bus").blockState.trySetValue(global.CDClientJavaClasses["$BlockStateProperties"].FACING, Direction.EAST), true)
                scene.idle(40)
