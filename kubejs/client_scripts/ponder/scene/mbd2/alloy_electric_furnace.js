    ...
    e.create([
        ...
        .scene(
            ...
            (builder, util) => {
                ...
                scene.rotateCameraY(-90)
                scene.idle(40)
                scene.overlay.showOutline("green", {}, [2, 2, 2, 6, 2, 6], 80)
                scene.text(40, "在这个多方块结构中, 这一层的锻造钢机壳可以被锻造钢输入/输出总线代替", [2, 2.5, 4.5]).attachKeyFrame()
                ...
                scene.idle(40)
                scene.rotateCameraY(90)
                scene.text(40, "在这个多方块结构中, 这一层的锻造钢机壳可以被锻造钢输入/输出总线代替", [7, 2.5, 4.5])
