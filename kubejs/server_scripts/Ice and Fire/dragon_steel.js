ServerEvents.recipes(e => {
    ...
    createmetallurgy.alloying(Fluid.of("createdelightcore:molten_fire_steel", 90), [Fluid.of("createdelightcore:molten_forged_steel", 90), Fluid.of("createdelight:fire_dragon_blood", 250), "#iceandfire:scales/dragon/fire"])
    .heatRequirement("superheated")
    .id("createdelight:alloying/molten_fire_steel")
    createmetallurgy.alloying(Fluid.of("createdelightcore:molten_ice_steel", 90), [Fluid.of("createdelightcore:molten_forged_steel", 90), Fluid.of("createdelight:ice_dragon_blood", 250), "#iceandfire:scales/dragon/ice"])
    .heatRequirement("superheated")
    .id("createdelight:alloying/molten_ice_steel")
    createmetallurgy.alloying(Fluid.of("createdelightcore:molten_lightning_steel", 90), [Fluid.of("createdelightcore:molten_forged_steel", 90), Fluid.of("createdelight:lightning_dragon_blood", 250), "#iceandfire:scales/dragon/lightning"])
    .heatRequirement("superheated")
