ServerEvents.recipes(e => {
    ...
    createmetallurgy.alloying(Fluid.of("createdelightcore:molten_fire_steel", 180), [Fluid.of("createdelightcore:molten_forged_steel", 90), Fluid.of("createdelight:fire_dragon_blood", 250), "iceandfire:dragonsteel_fire_ingot"])
    .heatRequirement("superheated")
    .id("createmetallurgy:alloying/molten_fire_steel_2")
    createmetallurgy.alloying(Fluid.of("createdelightcore:molten_ice_steel", 180), [Fluid.of("createdelightcore:molten_forged_steel", 90), Fluid.of("createdelight:ice_dragon_blood", 250), "iceandfire:dragonsteel_ice_ingot"])
    .heatRequirement("superheated")
    .id("createmetallurgy:alloying/molten_ice_steel_2")
    createmetallurgy.alloying(Fluid.of("createdelightcore:molten_lightning_steel", 180), [Fluid.of("createdelightcore:molten_forged_steel", 90), Fluid.of("createdelight:lightning_dragon_blood", 250), "iceandfire:dragonsteel_lightning_ingot"])
    .heatRequirement("superheated")
