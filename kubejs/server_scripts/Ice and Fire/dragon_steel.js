ServerEvents.recipes(e => {
    ...
    createmetallurgy.alloying(Fluid.of("createdelightcore:molten_fire_steel", 180), [Fluid.of("createdelightcore:molten_fire_steel", 90), Fluid.of("createdelight:fire_dragon_blood", 250), "northstar:martian_steel"])
    .heatRequirement("superheated")
    .id("createdelight:alloying/molten_fire_steel_2")
    createmetallurgy.alloying(Fluid.of("createdelightcore:molten_ice_steel", 180), [Fluid.of("createdelightcore:molten_ice_steel", 90), Fluid.of("createdelight:ice_dragon_blood", 250), "northstar:martian_steel"])
    .heatRequirement("superheated")
    .id("createdelight:alloying/molten_ice_steel_2")
    createmetallurgy.alloying(Fluid.of("createdelightcore:molten_lightning_steel", 180), [Fluid.of("createdelightcore:molten_lightning_steel", 90), Fluid.of("createdelight:lightning_dragon_blood", 250), "northstar:martian_steel"])
    .heatRequirement("superheated")
