ServerEvents.recipes(event => {
    ...
    // 序列组装：一阶火箭核心
    const iner_1 = "createdelight:incomplete_first_stage_rocket_core";
    create.sequenced_assembly(
        ...
        [
            ...
            create.deploying(iner_1, [iner_1, "immersive_aircraft:gyroscope"]),
            create.deploying(iner_1, [iner_1, "minecraft:nether_star"]),
            vintageimprovements.laser_cutting(iner_1, iner_1, 500),
        ]
    ).transitionalItem(iner_1).loops(1)
        .id("createdelight:first_stage_rocket_core");
    // 序列组装：二阶火箭核心
    const iner_2 = "createdelight:incomplete_second_stage_rocket_core";
    create.sequenced_assembly(
        [
        ...
        "ad_astra:desh_block",
        [
            vintageimprovements.turning(iner_2, iner_2),
            create.deploying(iner_2, [iner_2, "ad_astra:ice_shard"]),
            create.deploying(iner_2, [iner_2, "iceandfire:cyclops_eye"]),
            create.deploying(iner_2, [iner_2, "iceandfire:cockatrice_eye"]),
            vintageimprovements.laser_cutting(iner_2, iner_2, 500),
        ]
    ).transitionalItem(iner_2).loops(1)
        .id("createdelight:second_stage_rocket_core");
    // 序列组装：三阶火箭核心
    const iner_3 = "createdelight:incomplete_third_stage_rocket_core";
    create.sequenced_assembly(
        [
        ...
        [
            vintageimprovements.turning(iner_3, iner_3),
            create.deploying(iner_3, [iner_3, "ae2:engineering_processor"]),
            create.deploying(iner_3, [iner_3, "ae2:fluix_crystal"]),
            create.filling(iner_3, [iner_3, Fluid.of("createdelight:fire_dragon_blood", 500)]),
            vintageimprovements.laser_cutting(iner_3, iner_3, 500),
        ]
    ).transitionalItem(iner_3).loops(3)
        .id("createdelight:third_stage_rocket_core");
    // 序列组装：四阶火箭核心
    const iner_4 = "createdelight:incomplete_fourth_stage_rocket_core";
    create.sequenced_assembly(
        [
        ...
        [
            vintageimprovements.turning(iner_4, iner_4),
            create.deploying(iner_3, [iner_3, "ae2:engineering_processor"]),
            create.deploying(iner_3, [iner_3, "ae2:fluix_crystal"]),
            create.filling(iner_3, [iner_3, Fluid.of("createdelight:fire_dragon_blood", 500)]),
            create.filling(iner_3, [iner_3, Fluid.of("createdelight:lightning_dragon_blood", 500)]),
            vintageimprovements.laser_cutting(iner_4, iner_4, 500),
        ]
    ).transitionalItem(iner_4).loops(4)
