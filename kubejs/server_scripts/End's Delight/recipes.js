ServerEvents.recipes(e => {
    ...
    .heated()
    .id("createdelight:mixing/chorus_fruit_wine")
    ...
    ).id("createdelight:food/bubble_tea")
    let milktea_list = [
    ...
    brewingAndPouring(e, "create_dragons_plus:dragon_breath", ["minecraft:sugar"], "create_central_kitchen:dragon_breath_soda", 'ends_delight:dragon_breath_soda')
