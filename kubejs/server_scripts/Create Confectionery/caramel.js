ServerEvents.recipes(e => {
    ...
    e.recipes.create.mixing(
        ...
        .superheated()
        .id("createdelight:caramel_recipe")
    ...
    ).id("createdelight:filling/coffee/caramel_iced_coffee_filling")
    e.recipes.create.filling(
