ServerEvents.recipes(e => {
    ...
    createmetallurgy.melting(Fluid.of("createdelightcore:molten_desh", 120), "createdelight:desh_dust")
        .heatRequirement("heated")
        .id("createmetallurgy:melting/molten_desh_from_desh_dust")
    createmetallurgy.melting(Fluid.of("createdelightcore:molten_ostrum", 120), "createdelight:ostrum_dust")
        .heatRequirement("heated")
        .id("createmetallurgy:melting/molten_ostrum_from_ostrum_dust")
    createmetallurgy.melting(Fluid.of("createdelightcore:molten_calorite", 120), "createdelight:calorite_dust")
        .heatRequirement("heated")
