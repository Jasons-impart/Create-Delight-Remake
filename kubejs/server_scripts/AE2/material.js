ServerEvents.recipes((event) => {
  ...
  event.recipes.create_dragons_plus.freezing(
    "ae2:fluix_covered_cable",
    Ingredient.of("#ae2:covered_cable").subtract("ae2:fluix_covered_cable")
  ).id("createdelight:fan_freezing/fluix_covered_cable")
  event.recipes.create_dragons_plus.freezing(
    "ae2:fluix_glass_cable",
    Ingredient.of("#ae2:glass_cable").subtract("ae2:fluix_glass_cable")
  ).id("createdelight:fan_freezing/fluix_glass_cable")
  event.recipes.create_dragons_plus.freezing(
    "ae2:fluix_covered_dense_cable",
    Ingredient.of("#ae2:covered_dense_cable").subtract("ae2:fluix_covered_dense_cable")
  ).id("createdelight:fan_freezing/fluix_covered_dense_cable")
  event.recipes.create_dragons_plus.freezing(
    "ae2:fluix_smart_cable",
    Ingredient.of("#ae2:smart_cable").subtract("ae2:fluix_smart_cable")
  ).id("createdelight:fan_freezing/fluix_smart_cable")
  event.recipes.create_dragons_plus.freezing(
    "ae2:fluix_smart_dense_cable",
    Ingredient.of("#ae2:smart_dense_cable").subtract("ae2:fluix_smart_dense_cable")
