ServerEvents.recipes(event => {
    ...
    kubejs.shapeless(
        ...
        ["ae2:printed_engineering_processor", "2x #forge:dusts/redstone"]
    );
    kubejs.shapeless(
        "createdelight:initial_processing_of_printed_calculation_processor",
        ["ae2:printed_calculation_processor", "2x #forge:dusts/redstone"]
    );
    kubejs.shapeless(
        "createdelight:initial_processing_of_printed_logic_processor",
        ["ae2:printed_logic_processor", "2x #forge:dusts/redstone"]
    );
    kubejs.shapeless(
        "createdelight:initial_processing_of_printed_accumulation_processor",
        ["megacells:printed_accumulation_processor", "2x #forge:dusts/fluix"]
    );
    ...
    vintageimprovements.vacuumizing(
        "createdelight:initial_processing_of_printed_logic_processor",
        ["ae2:printed_logic_processor", "#forge:dusts/redstone"]
    );
    vintageimprovements.vacuumizing(
        "createdelight:initial_processing_of_printed_accumulation_processor",
    ...
    kubejs
        .shapeless(
            "createdelight:initial_processing_of_printed_logic_processor",
            ["ae2:printed_logic_processor", "createdelight:redstone_paste"]
        )
        .damageIngredient("createdelight:redstone_paste");
    ...
    // 膏合成
    create
        .mixing("createdelight:redstone_paste", [
            "64x #forge:dusts/redstone",
            "#forge:plates/iron",
        ])
        .heated();
    create
        .mixing("createdelight:glowstone_paste", [
            "64x #forge:dusts/glowstone",
            "#forge:plates/iron",
        ])
        .heated();
    create
        .mixing("createdelight:sky_stone_paste", [
            "64x ae2:sky_dust",
            "#forge:plates/iron",
        ])
        .heated();
    ...
    // 奇点
    create
        .cutting("ae2:singularity", "create:mechanical_saw")
        .id("createdelight:singularity_1");
    create
        .crushing("ae2:singularity", "#design_decor:crushing_wheels")
        .id("createdelight:singularity_2");
    create
        .milling("ae2:singularity", "#design_decor:millstones")
        .id("createdelight:singularity_3");

    // 陨石再生
    create
        .milling("4x ae2:sky_dust", "ae2:sky_stone_block")
        .id("createdelight:sky_dust_1");
    create
        .crushing(
    ...
    vintageimprovements
        .curving(
            "4x createdelight:item_cell_housing_blank",
            "#forge:ingots/iron"
        )
    ...
    vintageimprovements
        .curving(
            "4x createdelight:fluid_cell_housing_blank",
            "#forge:ingots/copper"
        )
        .head("createdelight:cell_housing_curving_head")
    ...
    vintageimprovements
        .curving(
            "4x createdelight:mega_item_cell_housing_blank",
    ...
    vintageimprovements
        .curving(
            "4x createdelight:mega_fluid_cell_housing_blank",
    ...
    create
        ...
        .id(
            "createdelight:initial_processing_of_item_cell_housing_sequenced_assembly"
        );
    create
        .sequenced_assembly(
        ...
        .id(
            "createdelight:initial_processing_of_fluid_cell_housing_sequenced_assembly"
        );
    create
        .sequenced_assembly(
            "createdelight:initial_processing_of_mega_item_cell_housing",
        ...
        .id(
            "createdelight:initial_processing_of_mega_item_cell_housing_sequenced_assembly"
        );
    create
        .sequenced_assembly(
            "createdelight:initial_processing_of_mega_fluid_cell_housing",
        ...
        .id(
            "createdelight:initial_processing_of_mega_fluid_cell_housing_sequenced_assembly"
        );

    vintageimprovements.vacuumizing(
        "createdelight:initial_processing_of_item_cell_housing",
        ["createdelight:item_cell_housing_blank", "#forge:dusts/redstone"]
    );
    vintageimprovements.vacuumizing(
        "createdelight:initial_processing_of_fluid_cell_housing",
        ["createdelight:fluid_cell_housing_blank", "#forge:dusts/redstone"]
    );
    vintageimprovements.vacuumizing(
        "createdelight:initial_processing_of_mega_item_cell_housing",
        [
    ...
    create
        ...
        .id(
            "createdelight:unformed_mega_fluid_cell_housing_sequenced_assembly"
        );
    ...
    vintageimprovements
        .curving(
            "4x createdelight:quartz_vibrant_glass_parts",
            "ae2:quartz_vibrant_glass"
        )
        .head("createdelight:cell_housing_curving_head")
    ...
    // 充能石英火把
    event.shaped("4x ae2:quartz_fixture", ["A", "B"], {
    ...
    // 陨石储罐
    create
        .item_application("ae2:sky_stone_tank", [
            "ae2:quartz_glass",
            "ae2:sky_stone_block",
        ])
        .id("createdelight:sky_stone_tank");
    kubejs.shapeless("ae2:sky_stone_tank", [
        "ae2:quartz_glass",
        "ae2:sky_stone_block",
    ]);
    ...
    create
        .sequenced_assembly(
            ...
            "ae2:blank_pattern",
            [
                create.deploying("ae2:blank_pattern", [
                    "ae2:blank_pattern",
                    "ae2:logic_processor",
                ]),
                create.deploying("ae2:blank_pattern", [
    ...
    create
        .deploying(Item.of("megacells:cell_dock", 10), [
            "ae2:drive",
            "#forge:ingots/sky_steel",
        ])
    ...
    create
        .sequenced_assembly("ae2:energy_cell", "ae2:quartz_glass", [
            create.deploying("ae2:quartz_glass", [
                "ae2:quartz_glass",
                "#forge:dusts/fluix",
            ]),
            create.deploying("ae2:quartz_glass", [
    ...
    create
        .sequenced_assembly(
            ...
            [
                create.deploying("ae2:crafting_terminal", [
                    "ae2:crafting_terminal",
                    "ae2:dense_energy_cell",
                ]),
                create.deploying("ae2:crafting_terminal", [
                ...
                create
                    .deploying("ae2:crafting_terminal", [
                        "ae2:crafting_terminal",
                        "#ae2:quartz_wrench",
                    ])
                    .keepHeldItem(),
    ...
    colours.forEach(c => {
        create.mixing(`4x minecraft:${c}_dye`, [
            `minecraft:${c}_dye`,
            "ae2:matter_ball",
        ]);
    });
    ...
    // ME量子环
    create
        .item_application("ae2:quantum_ring", [
    ...
    minecraft.stonecutting(
        "4x createdelight:iron_casing",
        "#forge:storage_blocks/iron"
    );

    // 陨钢外壳
    minecraft.stonecutting(
        "4x createdelight:sky_steel_casing",
    ...
    create
        .sequenced_assembly(
            ...
            "ae2:advanced_card",
            [
                create.deploying("ae2:advanced_card", [
                    "ae2:advanced_card",
                    "ae2:quantum_ring",
                ]),
                create.deploying("ae2:advanced_card", [
    ...
    create
        .sequenced_assembly("2x ae2:me_p2p_tunnel", "#forge:ingots/iron", [
            create.deploying("#forge:ingots/iron", [
                "#forge:ingots/iron",
                "ae2:engineering_processor",
            ]),
            create.deploying("#forge:ingots/iron", [
    ...
    // 空间IO端口
    create
        .item_application("ae2:spatial_io_port", [
            "createdelight:space_casing",
            "ae2:io_port",
        ])
    ...
    // 充能器
    create.item_application("ae2:charger", [
        "createdelight:iron_casing",
    ...
    create
        .sequenced_assembly(
            "2x megacells:mega_crafting_unit",
            "ae2:crafting_unit",
            [
