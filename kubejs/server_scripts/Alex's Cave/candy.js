ServerEvents.recipes(e => {
  ...
  ).id("createdelight:caramel_apple")
  ...
  ).id("createdelight:filling/caramel_apple")
  //苏打水
  ...
  ).id("createdelight:filling/purple_soda_bottle")
  e.recipes.create.emptying(
    ...
    'alexscaves:purple_soda_bottle'
  ).id("createdelight:emptying/purple_soda_bottle")
  //苏打水火箭
  ...
  ).id("createdelight:purple_soda_bottle_rocket")
  //薄荷糖
  e.recipes.create.mixing(
  ...
  ).id("createdelight:mint/mint_candies")
  e.recipes.kubejs.shapeless(
    'neapolitan:mint_candies',
    [
      'alexscaves:peppermint_powder',
  ...
  ).id("createdelight:mint/mint_candies_2")
  ...
  ).id("createdelight:block_of_frosted_chocolate").keepIngredient("alexscaves:block_of_frosting")
  e.recipes.create.mixing(
    Fluid.of("create_confectionery:black_chocolate", 100),
    'alexscaves:block_of_chocolate'
  ).heated().id("createdelight:mixing/block_of_chocolate")
  //糖霜块
  e.recipes.kubejs.shapeless( 
    'alexscaves:block_of_frosting',
    '4x minecraft:sugar'
  ).id("createdelight:block_of_frosting")
  e.recipes.kubejs.shapeless(
    '4x minecraft:sugar',
    'alexscaves:block_of_frosting'
  ).id("createdelight:sugar")
  e.recipes.kubejs.shapeless(
  ...
  ).id("createdelight:block_of_vanilla_frosting")
  e.recipes.kubejs.shapeless(
  ...
  ).id("createdelight:block_of_chocolate_frosting")
  //蛋糕胚
  e.recipes.create.compacting(
    "ratatouille:cake_base",
    "3x alexscaves:cake_layer"
  ).heated().id("createdelight:compacting/cake_base")
  e.recipes.create.cutting(
    "3x alexscaves:cake_layer",
    "ratatouille:cake_base"
  ).id("createdelight:cutting/cake_layer")
  //蛋糕合成
  e.recipes.kubejs.shaped(
    'minecraft:cake',
    [
  ...
  ).id("createdelight:cake_from_cake_layer")
  e.recipes.kubejs.shaped(
  ...
  ).id("createdelight:vanilla_cake_from_cake_layer")
  e.recipes.kubejs.shaped(
  ...
  ).id("createdelight:chocolate_cake_from_cake_layer")
  //曲奇
  e.recipes.create.cutting(
    '2x minecraft:cookie',
    'alexscaves:cookie_block'
  ).id("createdelight:cutting/cookie_block")
  //统一拐杖糖
  ...
  ).id("createdelight:grinding/sharpened_candy_cane")
  ...
  ).id("createdelight:compacting/dough_block")
