ServerEvents.recipes(e => {
    ...
    e.recipes.createdelight.alloy_electric_furnace()
        ...
        .inputFE(4000)
        .id("createdelight:alloy_electric_furnace/void_steel")
    //火星
    e.recipes.createdelight.alloy_electric_furnace()
    ...
    e.recipes.createdelight.alloy_electric_furnace()
        ...
        .inputFE(1000)
        .id("createdelight:alloy_electric_furnace/iron")
    e.recipes.createdelight.alloy_electric_furnace()
        .inputItems("#forge:dusts/gold")
        .outputItems("minecraft:gold_ingot")
        .inputFE(1000)
        .id("createdelight:alloy_electric_furnace/gold")
    e.recipes.createdelight.alloy_electric_furnace()
        .inputItems("#forge:dusts/copper")
        .outputItems("minecraft:copper_ingot")
        .inputFE(1000)
        .id("createdelight:alloy_electric_furnace/copper")
    e.recipes.createdelight.alloy_electric_furnace()
        .inputItems("#forge:dusts/silver")
        .outputItems("iceandfire:silver_ingot")
        .inputFE(1000)
        .id("createdelight:alloy_electric_furnace/silver")
    e.recipes.createdelight.alloy_electric_furnace()
        .inputItems("#forge:dusts/zinc")
        .outputItems("create:zinc_ingot")
        .inputFE(1000)
        .id("createdelight:alloy_electric_furnace/zinc")
    e.recipes.createdelight.alloy_electric_furnace()
        .inputItems("#forge:dusts/tin")
        .outputItems("createdelightcore:tin_ingot")
        .inputFE(1000)
        .id("createdelight:alloy_electric_furnace/tin")
    e.recipes.createdelight.alloy_electric_furnace()
        .inputItems("#forge:dusts/desh")
        .outputItems("ad_astra:desh_ingot")
        .inputFE(500)
        .id("createdelight:alloy_electric_furnace/desh")
    e.recipes.createdelight.alloy_electric_furnace()
        .inputItems("#forge:dusts/ostrum")
        .outputItems("ad_astra:ostrum_ingot")
        .inputFE(1000)
        .id("createdelight:alloy_electric_furnace/ostrum")
    e.recipes.createdelight.alloy_electric_furnace()
        .inputItems("#forge:dusts/calorite")
        .outputItems("ad_astra:calorite_ingot")
        .inputFE(4000)
        .id("createdelight:alloy_electric_furnace/calorite")
    e.recipes.createdelight.alloy_electric_furnace()
        .inputItems("#forge:dusts/tungsten")
        .outputItems("createmetallurgy:tungsten_ingot")
        .inputFE(3000)
        .id("createdelight:alloy_electric_furnace/tungsten")
    e.recipes.createdelight.alloy_electric_furnace()
        .inputItems("#forge:dusts/titanium")
        .outputItems("northstar:titanium_ingot")
        .inputFE(3000)
        .id("createdelight:alloy_electric_furnace/titanium")
})