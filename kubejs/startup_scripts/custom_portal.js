...
StartupEvents.postInit(e => {
    ...
    $CustomPortalBuilder
        ...
        .lightWithItem("alexscaves:sulfur_dust") //激活传送门的物品
    ...
    $CustomPortalBuilder
        .beginPortal() //开始构建自定义传送门
        ["frameBlock(net.minecraft.resources.ResourceLocation)"]("quark:ancient_wood") //传送门的框架方块
        .destDimID("createdelight:primordial_caves_dimension") //传送维度
        .lightWithItem("quark:ancient_sapling") //激活传送门的物品
        .tintColor(161, 119, 51) // 传送门的RGB颜色
        .registerPortal(); //注册自定义传送门

    $CustomPortalBuilder
        .beginPortal() //开始构建自定义传送门
        ["frameBlock(net.minecraft.resources.ResourceLocation)"]("farmersdelight:rich_soil") //传送门的框架方块
        .destDimID("createdelight:forlorn_hollows_dimension") //传送维度
        .lightWithItem("minecraft:dead_bush") //激活传送门的物品
