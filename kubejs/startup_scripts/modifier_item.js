ItemEvents.modification(e => {
    ...
    food_fastToEat('collectorsreap:portobello_quiche_slice')
    food_fastToEat('farmersdelight:chocolate_pie_slice')
    food_fastToEat('casualness_delight:stargazy_pie_slice')
    food_fastToEat('casualness_delight:quiche_lorraine_slice')
    food_fastToEat('farmersdelight:apple_pie_slice')
    food_fastToEat('farmersdelight:sweet_berry_cheesecake_slice')
    food_fastToEat('farmersrespite:rose_hip_pie_slice')
    food_fastToEat('oceanic_delight:sponge_cake_slice')
    food_fastToEat('cavedelight:slice_of_pinenut_pie')
    food_fastToEat('collectorsreap:lime_pie_slice')
    food_fastToEat('cosmopolitan:water_pie_slice')
    food_fastToEat('dungeonsdelight:sculk_tart_slice')
    food_fastToEat('dungeonsdelight:spider_pie_slice')
    food_fastToEat('youkaishomecoming:tarte_lune_slice')
    food_fastToEat('trailandtales_delight:cherry_cheese_pie_slice')
    food_fastToEat('cavedelight:slice_of_tectonic_cheesecake')
    food_fastToEat('bakeries:egg_tart')
    food_fastToEat('fruitsdelight:fig_tart')
    ...
    food_hungers("fluidlogistics:frost_cake", 10, 7)
    ...
    food_hungers('minecraft:pumpkin_pie', 10, 12)
    food_hungers('collectorsreap:portobello_quiche_slice', 4, 3)
    food_hungers('farmersdelight:chocolate_pie_slice', 5, 3)
    food_hungers('casualness_delight:stargazy_pie_slice', 5, 4)
    food_hungers('casualness_delight:quiche_lorraine_slice', 6, 5)
    food_hungers('farmersdelight:apple_pie_slice', 2.5, 3)
    food_hungers('farmersdelight:sweet_berry_cheesecake_slice', 3, 4)
    food_hungers('farmersrespite:rose_hip_pie_slice', 2.5, 3)
    food_hungers('oceanic_delight:sponge_cake_slice', 1, 0.5)
    food_hungers('cavedelight:slice_of_pinenut_pie', 3, 3)
    food_hungers('collectorsreap:lime_pie_slice', 2.5, 3)
    food_hungers('cosmopolitan:water_pie_slice', 2, 1)
    food_hungers('dungeonsdelight:sculk_tart_slice', 4, 3)
    food_hungers('dungeonsdelight:spider_pie_slice', 2, 1)
    food_hungers('youkaishomecoming:tarte_lune_slice', 2.5, 3)
    food_hungers('trailandtales_delight:cherry_cheese_pie_slice', 3, 4)
    food_hungers('cavedelight:slice_of_tectonic_cheesecake', 3, 4)
    ...
    food_effects("fluidlogistics:frost_cake", "minecraft:slowness", 30, 2)
    food_effects("fluidlogistics:frost_cake", "minecraft:strength", 30, 2)
