...
StartupEvents.modifyCreativeTab("createdelightcore:food", e => {
  ...
  e.add([
    ...
    'createdelight:unbake_chorus_fruit_pie',
    'createdelight:unbake_apple_pie',
    'createdelight:unbake_sweet_berry_cheesecake',
    'createdelight:unbake_chocolate_pie',
    'createdelight:unbake_rose_hip_pie',
    'createdelight:unbake_lime_pie',
    'createdelight:unbake_pinenut_pie',
    'createdelight:unbake_cherry_cheese_pie',
    'createdelight:unbake_tarte_lune',
    'createdelight:unbake_spider_pie',
    'createdelight:unbake_sculk_tart',
    'createdelight:unbake_tectonic_cheesecake',
    ...
    'createdelight:unbake_pineapple_pie',
    'createdelight:unbake_durian_pie',
    // 曲奇面团
