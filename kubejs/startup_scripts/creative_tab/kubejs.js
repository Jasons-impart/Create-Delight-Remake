StartupEvents.modifyCreativeTab("kubejs:tab", e => {
    e.remove([
        ...
        'createdelight:incomplete_heartburger',
        'createdelight:incomplete_cheese_burger',
        'createdelight:incomplete_deluxe_burger',
        'createdelight:incomplete_portobello_burger',
        'createdelight:incomplete_land_and_sea_burger',
        'createdelight:incomplete_kangaroo_burger',
        'createdelight:incomplete_bunfungus_sandwich',
        'createdelight:incomplete_mutton_sandwich',
        'createdelight:incomplete_egg_sandwich',
        'createdelight:incomplete_chicken_sandwich',
        'createdelight:incomplete_bacon_sandwich',
        'createdelight:incomplete_prawn_po_boy',
        'createdelight:incomplete_lux_and_ham_sandwich',
        'createdelight:incomplete_pine_and_sap_sandwich',
        'createdelight:incomplete_vegan_hamburger',
